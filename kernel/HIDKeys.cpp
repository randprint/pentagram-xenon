...
HID_Key HID_translateSDLJoystickButton(uint8 button)
{
	switch(button)
	{
		...
		case 7: return HID_JOY8;
		case 8: return HID_JOY9;
		case 9: return HID_JOY10;
		case 10: return HID_JOY11;
		case 11: return HID_JOY12;
		case 12: return HID_JOY13;
		case 13: return HID_JOY14;
		case 14: return HID_JOY15;
		case 15: return HID_JOY16;
		default:
			break;
	}
	return HID_LAST;
